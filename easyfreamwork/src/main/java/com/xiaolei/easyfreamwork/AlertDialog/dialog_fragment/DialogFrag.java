...
public class DialogFrag extends DialogFragment implements DialogFragmentInterface
{
    ...
    public DialogFrag(FragmentManager fragmentManager)
    {
    ...
    {
        show(fragmentManager, "DialogFrag");
        return this;
    }
}
